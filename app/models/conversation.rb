class Conversation < ActiveRecord::Base
  attr_accessible :body, :subject, :lat, :long, :markread, :alert, :badge, :sound, :schedule, :custom, :token, :address, :ltoken, :random, :mute, :timed, :area, :attachment, :subject if Mailboxer.protected_attributes?
